...
This directory contains a series of progressive examples to help you understand how to use the Grape Agent framework.
...
3. Go directly to interactive mode with `grape-agent`
